...
import 'package:user/DocumentOnline/document_online.dart';
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          widget.document["specialDocument"]
                              ? "ویژه"
            ...
            children: [
              Column(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      widget.remove(int.parse(widget.document['id']));
                    },
                    child: const Icon(
                      Icons.more_vert_rounded,
                      color: gray,
