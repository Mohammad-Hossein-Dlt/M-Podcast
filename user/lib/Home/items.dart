...
import 'package:user/Bloc/SubGroupsBloc/subgroups_block.dart';
...
class AllDocumentsItem extends StatefulWidget {
  ...
  @override
  State<AllDocumentsItem> createState() => _AllDocumentsItemState();
}

class _AllDocumentsItemState extends State<AllDocumentsItem> {
  @override
  void initState() {
...
class AllDocumentsItem2 extends StatefulWidget {
  const AllDocumentsItem2({
    super.key,
    required this.title,
    this.by = "newest",
    required this.preTitle,
  ...
  final GroupSubgroup? fromCategories;
  @override
  State<AllDocumentsItem2> createState() => _AllDocumentsItem2State();
}

class _AllDocumentsItem2State extends State<AllDocumentsItem2> {
  @override
  void initState() {
    if (widget.fromCategories != null) {
      BlocProvider.of<FetchDocumentsBloc>(context)
                              ...
                              child: Row(
                                children: [
                                  TextButton(
                                    ...
                                    child: const ShowMore(color: Colors.white),
                                    onPressed: () {
                                      if (widget.fromCategories != null) {
                                        Get.to(
                                          BlocProvider(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        TextButton(
                                          ...
                                          child: const ShowMore(color: black),
                                          onPressed: () {
                                            if (widget.fromCategories != null) {
                                              Get.to(
                                                BlocProvider(
